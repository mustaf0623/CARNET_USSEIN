...
export function renderObservations() {
  ...
  return `<div class="page-head"><div><div class="eyebrow">Suivi</div><h1 class="page-title">Observations</h1><p class="page-sub">Espace dՎchange entre le Visiteur (PF) et la Commission Administrative de la Section. Echange visible uniquement par la CA et le super-admin.</p></div></div>
